...
export const APP_CONFIG = {
  appName: "LearnHub",                       // Display name (sidebar header, page title)
  projectName: "Single Vendor LMS",          // Client's product name (tab bar microtext, footer)
  clientName: null as string | null,         // Client first name, or null — never render "null"
  domain: "education",                       // Domain (finance, health, marketplace, tech, etc.)
